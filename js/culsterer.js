(function(o) {
    ...
    Array.prototype.filter || (Array.prototype.filter = function(a, b) {
        ...
        if (b === void 0)
            for (; ++c !== d; )
                c in this && a(this[c], c, this) && (e[f++] = this[c]);
        else
            for (; ++c !== d; )
                c in this && a.call(b, this[c], c, this) && (e[f++] = this[c]);
        e.length = f;
        return e
    }
    );
    ...
    var q = !!n.apikey
      ...
      , l = !1
      , m = null
      , s = ("https:" == o.location.protocol ? "https:" : "http:") + "//" + (daum.maps.TUNNELING ? "ssl.daumcdn.net" : "i1.daumcdn.net") + "/localimg/localimages/07/mapjsapi/cluster.png"
      , h = {
        _POOL: {},
        _ID: 0
    };
    ...
    h.unlisten = function(a) {
        var b = h._POOL[a];
        if (b) {
            b.target.removeEventListener ? b.target.removeEventListener(b.type, b, false) : b.target.detachEvent("on" + b.type, b);
            delete h._POOL[a]
        }
    }
    ;
    ...
    ;
    g.prototype._updateIcon = function() {
        var a = this._map
          , b = this._model
          , d = this._markers
        ...
        if (g && f < g)
            for (b = 0; c = d[b]; b++)
                c.setMap(a);
        else if (i < b.minClusterSize)
            c.setVisible(l);
        else {
            c.setPosition(this._center);
            c.setVisible(true);
            var a = b.getStyle(i), h;
            for (h in a)
                this._content.style[h] = a[h];
    ...
    g.prototype.remove = function() {
        for (var a = m; (a = this._eventIds.pop()) !== void 0; )
            h.unlisten(a);
    ...
    c.prototype.removeMarkers = function(a, b) {
        for (var c = l, e = 0, f; f = a[e]; e++)
            c = this._removeMarker(f, true) || c;
        !b && c && this.redraw()
    }
    ;
    ...
    c.prototype._resetViewport = function(a) {
        for (var b = 0, c; c = this._clusters[b]; b++)
            c.remove();
    ...
    c.prototype._createClusters = function() {
        if (this.getMap()) {
            var a, b, c = this._markers, e = this.getMap();
            ...
            for (a = 0; b = c[a]; a++)
                !b.isAdded && f.contain(j(b.getPosition())) && (i ? this._addToClosestCluster(b) : b.setMap(e));
    ...
    c.prototype._addToClosestCluster = function(a) {
        for (var b = j(a.getPosition()), c = m, e = Infinity, f = 0, h; h = this._clusters[f]; f++) {
            var i = j(h.getCenter())
              , i = r(b.getX() - i.getX()) + r(b.getY() - i.getY());
            if (e > i) {
                e = i;
                c = h
            }
    ...
    ;
    c.prototype.setCalculator = function(a) {
